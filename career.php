            ...
            <div class="-my-8 divide-y-2 divide-gray-100">
                <div class="py-8 flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="md:flex-grow">
                        <h2 class="text-2xl font-medium text-gray-900 title-font mb-2">Join the winning team</h2>
                        <p class="leading-relaxed">Indian Bank is a young and dynamic bank, with a youthful and
                            enthusiastic team determined to accomplish the vision of becoming a world-class Indian ban
                        </p>
                ...
                <div class="py-8 flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="md:flex-grow">
                        <h2 class="text-2xl font-medium text-gray-900 title-font mb-2">Future Bankers Program</h2>
                        <p class="leading-relaxed">Future Bankers Program is an initiative of HDFC Bank to attract and
                            develop young talent, who wish to pursue a career in Banking. This program aims to turn
                            young graduates into highly-trained, well-groomed, customer-facing personnel.</p>
                ...
                <div class="py-8 flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="md:flex-grow">
                        <h2 class="text-2xl font-medium text-gray-900 title-font mb-2">Trade Finance Program</h2>
                        <p class="leading-relaxed">Indian Bank's Trade Finance Program is an exciting new opportunity to
                            start a career in Trade Operations with us. Designed in collaboration with BankEdge, it
                            empowers bright young graduates with the knowledge and skills they need to become a part of
                            our Trade Finance team.</p>
