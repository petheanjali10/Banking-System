      ...
      <div class="flex flex-wrap -mx-4 -mb-10 text-center">
        <div class="sm:w-1/2 mb-10 px-4">
          <div class="rounded-lg h-64 overflow-hidden">
            <img alt="content" class="object-cover object-center h-full w-full" src="awards1.webp">
          </div>
          <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">Asia's outstanding companies poll</h2>
          <p class="leading-relaxed text-base">outstanding company among banks in India</p>

        </div>
        <div class="sm:w-1/2 mb-10 px-4">
          <div class="rounded-lg h-64 overflow-hidden">
            <img alt="content" class="object-cover object-center h-full w-full" src="award3.webp">
          </div>
          <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">Euromoney Awards for Excellence 2021</h2>
          <p class="leading-relaxed text-base">India's best Bank</p>
